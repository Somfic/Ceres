...
namespace Ceres.ECS.Resource
{
    ...
    public abstract class ResourceManager<TInfo, TResource> : IResourceManager, IDisposable
    {
        #region Types
        ...
        /// <summary>
        /// Allows to enumerate the resources of a <see cref="ResourceManager{TInfo,TResource}" />.
        /// </summary>
        public readonly struct ResourceEnumerable : IEnumerable<KeyValuePair<TInfo, TResource>>
        {
            private readonly ResourceManager<TInfo, TResource> _manager;

            internal ResourceEnumerable(ResourceManager<TInfo, TResource> manager)
            {
                _manager = manager;
            }
        ...
        /// <summary>
        /// Enumerates the resources of a <see cref="ResourceManager{TInfo,TResource}" />.
        /// </summary>
        public struct ResourceEnumerator : IEnumerator<KeyValuePair<TInfo, TResource>>
        {
            ...
            internal ResourceEnumerator(ResourceManager<TInfo, TResource> manager)
            {
            ...
            /// <summary>Advances the enumerator to the next resource of the <see cref="ResourceManager{TInfo,TResource}" />.</summary>
        ...
        /// <summary>
        /// Creates an instance of type <see cref="ResourceManager{TInfo,TResource}"/>.
        /// </summary>
        ...
        /// <summary>
        /// Sets up current <see cref="ResourceManager{TInfo,TResource}"/> instance to react to <see cref="ManagedResource{TInfo, TResource}"/> components on <see cref="Entity"/> instances of the provided <see cref="World"/>.
        ...
        /// <returns>An <see cref="IDisposable"/> instance used to make current <see cref="ResourceManager{TInfo,TResource}"/> instance stop reacting to <see cref="ManagedResource{TInfo, TResource}"/> component of the provided <see cref="World"/>.</returns>

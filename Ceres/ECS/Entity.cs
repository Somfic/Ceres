...
using Ceres.ECS.Internal.Diagnostics;
using Ceres.ECS.Internal.Extensions;
using Ceres.ECS.Internal.Messages;
...
namespace Ceres.ECS
{
    ...
    public readonly struct Entity : IDisposable, IEquatable<Entity>
    {
        ...
        /// <summary>
        /// Gets the <see cref="ECS.World"/> instance from which current <see cref="Entity"/> originate.
        /// </summary>
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        ...
        /// </summary>
        /// <exception cref="InvalidOperationException"><see cref="Entity"/> was not created from a <see cref="ECS.World"/>.</exception>
        public void Enable()
        {
        ...
        /// <exception cref="InvalidOperationException"><see cref="Entity"/> was not created from a <see cref="ECS.World"/>.</exception>
        /// <exception cref="InvalidOperationException">Reference <see cref="Entity"/> comes from a different <see cref="ECS.World"/>.</exception>
        ...
        /// <exception cref="Exception"><see cref="Entity"/> was not created from a <see cref="ECS.World"/> or does not have a component of type <typeparamref name="T"/>.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ref T Get<T>() => ref ComponentManager<T>.Pools[WorldId].Get(EntityId);

        /// <summary>
        /// Creates a copy of current <see cref="Entity"/> with all of its components in the given <see cref="ECS.World"/> using the given <see cref="ComponentCloner"/>.
        /// This method is not thread safe.
        /// </summary>
        /// <param name="world">The <see cref="ECS.World"/> instance to which copy current <see cref="Entity"/> and its components.</param>
        /// <param name="cloner">The <see cref="ComponentCloner"/> to use to copy the components.</param>
        /// <returns>The created <see cref="Entity"/> in the given <see cref="ECS.World"/>.</returns>
        ...
        /// <summary>
        /// Creates a copy of current <see cref="Entity"/> with all of its components in the given <see cref="ECS.World"/>.
        /// This method is not thread safe.
        /// </summary>
        /// <param name="world">The <see cref="ECS.World"/> instance to which copy current <see cref="Entity"/> and its components.</param>
        /// <returns>The created <see cref="Entity"/> in the given <see cref="ECS.World"/>.</returns>

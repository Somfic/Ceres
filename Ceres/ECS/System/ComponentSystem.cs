...
namespace Ceres.ECS.System
{
    ...
    public abstract class ComponentSystem<TState, TComponent> : ISystem<TState>
    {
        #region Types

        private class Runnable : IParallelRunnable
        {
            private readonly ComponentSystem<TState, TComponent> _system;

            public TState CurrentState;
            public int ComponentsPerIndex;

            public Runnable(ComponentSystem<TState, TComponent> system)
            {
                _system = system;
            }
        ...
        /// <summary>
        /// Initialise a new instance of the <see cref="ComponentSystem{TState,TComponent}"/> class with the given <see cref="World"/> and <see cref="IParallelRunner"/>.
        /// </summary>
        ...
        protected ComponentSystem(World world, IParallelRunner runner, int minComponentCountByRunnerIndex)
        {
        ...
        /// <param name="runner">The <see cref="IParallelRunner"/> used to process the update in parallel if not null.</param>
        /// <exception cref="ArgumentNullException"><paramref name="world"/> is null.</exception>
        protected ComponentSystem(World world, IParallelRunner runner)
            : this(world, runner, 0)
        { }

        /// <summary>
        /// Initialise a new instance of the <see cref="ComponentSystem{TState,TComponent}"/> class with the given <see cref="World"/>.
        /// </summary>
        /// <param name="world">The <see cref="World"/> on which to process the update.</param>
        /// <exception cref="ArgumentNullException"><paramref name="world"/> is null.</exception>
        ...
        /// <summary>
        /// Gets or sets whether the current <see cref="ComponentSystem{TState,TComponent}"/> instance should update or not.
        /// </summary>

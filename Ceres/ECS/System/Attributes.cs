using Ceres.ECS.Internal.Extensions;

namespace Ceres.ECS.System
{
    /// <summary>
    /// Makes so when building the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance, it will only contain disabled entities.
    /// </summary>
    ...
    /// <summary>
    /// Makes so when building the inner EntitySet of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance, the decorated method will be used as a component predicate.
    ...
    /// <summary>
    /// Represents the base attribute to declare how to build the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance.
    ...
    /// <summary>
    /// Represents a component type to include when building the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Represents a group of component types which at least one should be present when building the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Represents a component type to exclude when building the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Represents a group of component types which at least one should not be present when building the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Represents a component type to react to its addition when building the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Represents a group of component types to react to at least one of their addition when building the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Represents a component type to react to its change when building the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Represents a group of component types to react to at least one of their change when building the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Represents a component type to react to its deletion when building the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance.
    /// </summary>
    ...
    /// <summary>
    /// Represents a group of component types to react to at least one of their deletion when building the inner <see cref="EntitySet"/> of <see cref="EntitySetSystem{T}"/> when giving a <see cref="World"/> instance.
    /// </summary>

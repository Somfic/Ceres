...
using Ceres.ECS.Internal;
using Ceres.ECS.Internal.Extensions;
using Ceres.ECS.Internal.System;
...
namespace Ceres.ECS.System
{
    ...
    public abstract class EntityMultiMapSystem<TState, TKey> : ISystem<TState>
    {
        #region Types

        private sealed class Runnable : IParallelRunnable
        {
            private readonly EntityMultiMapSystem<TState, TKey> _system;
            ...
            public Runnable(EntityMultiMapSystem<TState, TKey> system)
            {
                _system = system;
            }
        ...
        /// <summary>
        /// Gets the <see cref="ECS.World"/> instance on which this system operates.
        /// </summary>
        ...
        private EntityMultiMapSystem(Func<object, EntityMultiMap<TKey>> factory, IParallelRunner runner, int minEntityCountByRunnerIndex)
        {
        ...
        /// <summary>
        /// Initialise a new instance of the <see cref="EntityMultiMapSystem{TState,TKey}"/> class with the given <see cref="EntityMultiMap{TKey}"/> and <see cref="IParallelRunner"/>.
        /// </summary>
        ...
        protected EntityMultiMapSystem(EntityMultiMap<TKey> map, IParallelRunner runner, int minEntityCountByRunnerIndex = 0)
            : this(map is null ? throw new ArgumentNullException(nameof(map)) : _ => map, runner, minEntityCountByRunnerIndex)
        { }

        /// <summary>
        /// Initialise a new instance of the <see cref="EntityMultiMapSystem{TState,TKey}"/> class with the given <see cref="EntityMultiMap{TKey}"/>.
        /// </summary>
        /// <param name="map">The <see cref="EntityMultiMap{TKey}"/> on which to process the update.</param>
        /// <param name="useBuffer">Whether the entities should be copied before being processed.</param>
        /// <exception cref="ArgumentNullException"><paramref name="map"/> is null.</exception>
        protected EntityMultiMapSystem(EntityMultiMap<TKey> map, bool useBuffer = false)
            : this(map, null)
        {
        ...
        /// <summary>
        /// Initialise a new instance of the <see cref="EntityMultiMapSystem{TState,TKey}"/> class with the given <see cref="ECS.World"/> and factory.
        /// The current instance will be passed as the first parameter of the factory.
        /// </summary>
        /// <param name="world">The <see cref="ECS.World"/> from which to get the <see cref="Entity"/> instances to process the update.</param>
        /// <param name="factory">The factory used to create the <see cref="EntityMultiMap{TKey}"/>.</param>
        /// <param name="runner">The <see cref="IParallelRunner"/> used to process the update in parallel if not null.</param>
        /// <param name="minEntityCountByRunnerIndex">The minimum number of <see cref="Entity"/> per runner index to use the given <paramref name="runner"/>.</param>
        /// <exception cref="ArgumentNullException"><paramref name="world"/> is null.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="factory"/> is null.</exception>
        protected EntityMultiMapSystem(World world, Func<object, World, EntityMultiMap<TKey>> factory, IParallelRunner runner, int minEntityCountByRunnerIndex)
        ...
        /// <summary>
        /// Initialise a new instance of the <see cref="EntityMultiMapSystem{TState,TKey}"/> class with the given <see cref="ECS.World"/>.
        ...
        /// <param name="minEntityCountByRunnerIndex">The minimum number of <see cref="Entity"/> per runner index to use the given <paramref name="runner"/>.</param>
        /// <exception cref="ArgumentNullException"><paramref name="world"/> is null.</exception>
        protected EntityMultiMapSystem(World world, IParallelRunner runner, int minEntityCountByRunnerIndex = 0)
        ...
        /// <exception cref="ArgumentNullException"><paramref name="world"/> is null.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="factory"/> is null.</exception>
        protected EntityMultiMapSystem(World world, Func<object, World, EntityMultiMap<TKey>> factory, bool useBuffer)
        ...
        /// <param name="useBuffer">Whether the entities should be copied before being processed.</param>
        /// <exception cref="ArgumentNullException"><paramref name="world"/> is null.</exception>
        protected EntityMultiMapSystem(World world, bool useBuffer = false)
        ...
        /// <summary>
        /// Gets or sets whether the current <see cref="EntityMultiMapSystem{TState,TKey}"/> instance should update or not.
        /// </summary>

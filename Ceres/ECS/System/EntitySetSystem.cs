...
namespace Ceres.ECS.System
{
    ...
    public abstract class EntitySetSystem<T> : ISystem<T>
    {
        #region Types

        private class Runnable : IParallelRunnable
        {
            private readonly EntitySetSystem<T> _system;

            public T CurrentState;
            public int EntitiesPerIndex;

            public Runnable(EntitySetSystem<T> system)
            {
                _system = system;
            }
        ...
        private EntitySetSystem(Func<object, EntitySet> factory, IParallelRunner runner, int minEntityCountByRunnerIndex)
        {
            Set = factory(this);
            World = Set.World;
        ...
        /// <summary>
        /// Initialise a new instance of the <see cref="EntitySetSystem{T}"/> class with the given <see cref="EntitySet"/> and <see cref="IParallelRunner"/>.
        /// </summary>
        ...
        protected EntitySetSystem(EntitySet set, IParallelRunner runner, int minEntityCountByRunnerIndex = 0)
            : this(set is null ? throw new ArgumentNullException(nameof(set)) : _ => set, runner, minEntityCountByRunnerIndex)
        { }

        /// <summary>
        /// Initialise a new instance of the <see cref="EntitySetSystem{T}"/> class with the given <see cref="EntitySet"/>.
        /// </summary>
        /// <param name="set">The <see cref="EntitySet"/> on which to process the update.</param>
        /// <param name="useBuffer">Whether the entities should be copied before being processed.</param>
        /// <exception cref="ArgumentNullException"><paramref name="set"/> is null.</exception>
        protected EntitySetSystem(EntitySet set, bool useBuffer = false)
            : this(set, null)
        {
        ...
        /// <summary>
        /// Initialise a new instance of the <see cref="EntitySetSystem{T}"/> class with the given <see cref="ECS.World"/> and factory.
        ...
        protected EntitySetSystem(World world, Func<object, World, EntitySet> factory, IParallelRunner runner, int minEntityCountByRunnerIndex)
        ...
        /// <summary>
        /// Initialise a new instance of the <see cref="EntitySetSystem{T}"/> class with the given <see cref="ECS.World"/>.
        ...
        /// <param name="minEntityCountByRunnerIndex">The minimum number of <see cref="Entity"/> per runner index to use the given <paramref name="runner"/>.</param>
        /// <exception cref="ArgumentNullException"><paramref name="world"/> is null.</exception>
        protected EntitySetSystem(World world, IParallelRunner runner, int minEntityCountByRunnerIndex = 0)
        ...
        /// <exception cref="ArgumentNullException"><paramref name="world"/> is null.</exception>
        /// <exception cref="ArgumentNullException"><paramref name="factory"/> is null.</exception>
        protected EntitySetSystem(World world, Func<object, World, EntitySet> factory, bool useBuffer)
        ...
        /// <param name="useBuffer">Whether the entities should be copied before being processed.</param>
        /// <exception cref="ArgumentNullException"><paramref name="world"/> is null.</exception>
        protected EntitySetSystem(World world, bool useBuffer = false)
        ...
        /// <summary>
        /// Gets or sets whether the current <see cref="EntitySetSystem{T}"/> instance should update or not.
        /// </summary>

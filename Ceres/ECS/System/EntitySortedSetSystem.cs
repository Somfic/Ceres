...
namespace Ceres.ECS.System
{
    ...
    public abstract class EntitySortedSetSystem<TState, TComponent> : ISystem<TState>
    {
        #region Fields
        ...
        private EntitySortedSetSystem(Func<object, EntitySortedSet<TComponent>> factory)
        {
        ...
        /// <summary>
        /// Initialise a new instance of the <see cref="EntitySortedSetSystem{TState,TComponent}"/> class with the given <see cref="EntitySortedSet{TComponent}"/>.
        /// </summary>
        ...
        protected EntitySortedSetSystem(EntitySortedSet<TComponent> sortedSet, bool useBuffer = false)
        ...
        /// <summary>
        /// Initialise a new instance of the <see cref="EntitySortedSetSystem{TState,TComponent}"/> class with the given <see cref="ECS.World"/> and factory.
        ...
        protected EntitySortedSetSystem(World world, Func<object, World, EntitySortedSet<TComponent>> factory, bool useBuffer)
        ...
        /// <param name="useBuffer">Whether the entities should be copied before being processed.</param>
        /// <exception cref="ArgumentNullException"><paramref name="world"/> is null.</exception>
        protected EntitySortedSetSystem(World world, bool useBuffer = false)
        ...
        /// <summary>
        /// Gets or sets whether the current <see cref="EntitySortedSetSystem{TState,TComponent}"/> instance should update or not.
        /// </summary>

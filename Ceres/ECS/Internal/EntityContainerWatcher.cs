...
namespace Ceres.ECS.Internal
{
    internal sealed class EntityContainerWatcher
    {
        ...
        private readonly ECS.IEntityContainer _container;
        ...
        public EntityContainerWatcher(ECS.IEntityContainer container, Predicate<ComponentEnum> filter, Predicate<int> predicate)
        {
